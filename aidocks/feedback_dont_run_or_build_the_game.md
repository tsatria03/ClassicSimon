...
Never launch or compile ClassicSimon yourself — not `csm/csm.py`, not `build/tools.py`, not `nvgt -c`. Make the edits, report them, and stop. The dev runs the launcher and builds/verifies releases.
