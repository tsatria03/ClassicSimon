...
description: "Keep every line in the player-facing docks (csm/docks/) at or under 1024 characters."
metadata:
  node_type: memory
  type: feedback
...
Keep every line in the player-facing docks — `csm/docks/readme.txt`, `changelog.txt`, `credits.txt`, `todo_list.txt` — at or under 1024 characters.
